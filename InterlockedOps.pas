...
{-------------------------------------------------------------------------------
  ...
  InterlockedCompareExchange
    ...
    WARNING - 128bit variant requires the variable Destination to be located in
...
{-------------------------------------------------------------------------------
  ...
  InterlockedBitTestAndSetStr
    ...
    NOTE - InterlockedBitTestAndSetStr without width specification (ie. number
           ...
           program and InterlockedBitTestAndSetStr64 in 64bit program.
...
{-------------------------------------------------------------------------------
  ...
  InterlockedStore
    ...
    and returns original value of I (so it is functionally equivalent to
    InterlockedExchange).
...
{-------------------------------------------------------------------------------
  ...
  InterlockedOperation
    ...
    Performs operation implemented in function passed as Op parameter (calls
    this function) on value of variable (pointed to by) A, stores the result
    (what the Op function returns) back in A and returns the value stored in
    InterlockedResult (this parameter is initialized to value of A upon each
    entry to the operation), everything in an atomic manner - that is,
    everything is completed thread-safe.
...
-------------------------------------------------------------------------------}
type
  TInterlockedOp8u = Function(A: UInt8; var InterlockedResult: UInt8): UInt8; register;
  TInterlockedOp8s = Function(A: Int8; var InterlockedResult: Int8): Int8; register;

  TInterlockedOp16u = Function(A: UInt16; var InterlockedResult: UInt16): UInt16; register;
  TInterlockedOp16s = Function(A: Int16; var InterlockedResult: Int16): Int16; register;

  TInterlockedOp32u = Function(A: UInt32; var InterlockedResult: UInt32): UInt32; register;
  TInterlockedOp32s = Function(A: Int32; var InterlockedResult: Int32): Int32; register;

{$IFDEF IncludeVal64}
  TInterlockedOp64u = Function(A: UInt64; var InterlockedResult: UInt64): UInt64; register;
  TInterlockedOp64s = Function(A: Int64; var InterlockedResult: Int64): Int64; register;
{$ENDIF}

  TInterlockedOpPtr = Function(A: Pointer; var InterlockedResult: Pointer): Pointer; register;

  TInterlockedOpBool = Function(A: Boolean; var InterlockedResult: Boolean): Boolean; register;

//------------------------------------------------------------------------------

Function InterlockedOperation8(A: Pointer; Op: TInterlockedOp8u): UInt8;{$IFDEF CanInline} inline;{$ENDIF} overload;
Function InterlockedOperation16(A: Pointer; Op: TInterlockedOp16u): UInt16;{$IFDEF CanInline} inline;{$ENDIF} overload;
Function InterlockedOperation32(A: Pointer; Op: TInterlockedOp32u): UInt32;{$IFDEF CanInline} inline;{$ENDIF} overload;
{$IFDEF IncludeVal64}
Function InterlockedOperation64(A: Pointer; Op: TInterlockedOp64u): UInt64;{$IFDEF CanInline} inline;{$ENDIF} overload;
{$ENDIF}
Function InterlockedOperationPtr(A: Pointer; Op: TInterlockedOpPtr): Pointer;{$IFDEF CanInline} inline;{$ENDIF} overload;
Function InterlockedOperationBool(A: Pointer; Op: TInterlockedOpBool): Boolean;{$IFDEF CanInline} inline;{$ENDIF} overload;

//------------------------------------------------------------------------------

Function InterlockedOperation(var A: UInt8; Op: TInterlockedOp8u): UInt8; overload;
Function InterlockedOperation(var A: Int8; Op: TInterlockedOp8s): Int8; overload;

Function InterlockedOperation(var A: UInt16; Op: TInterlockedOp16u): UInt16; overload;
Function InterlockedOperation(var A: Int16; Op: TInterlockedOp16s): Int16; overload;

Function InterlockedOperation(var A: UInt32; Op: TInterlockedOp32u): UInt32; overload;
Function InterlockedOperation(var A: Int32; Op: TInterlockedOp32s): Int32; overload;

{$IFDEF IncludeVal64}
Function InterlockedOperation(var A: UInt64; Op: TInterlockedOp64u): UInt64; overload;
Function InterlockedOperation(var A: Int64; Op: TInterlockedOp64s): Int64; overload;
{$ENDIF}

Function InterlockedOperation(var A: Pointer; Op: TInterlockedOpPtr): Pointer; overload;

Function InterlockedOperation(var A: Boolean; Op: TInterlockedOpBool): Boolean; overload;

{===============================================================================
--------------------------------------------------------------------------------
                      Interlocked operation (one argument)                       
--------------------------------------------------------------------------------
===============================================================================}
{-------------------------------------------------------------------------------
  ...
  InterlockedOperation
    ...
    Works the same as overloads with no argument (see there for details, notes
    and warnings), except that the Op function also receives one additional
    argument which can be used for any purpose (eg. as an additional parameter
    for the operation).

-------------------------------------------------------------------------------}
type
  TInterlockedOpArg8u = Function(A,B: UInt8; var InterlockedResult: UInt8): UInt8; register;
  TInterlockedOpArg8s = Function(A,B: Int8; var InterlockedResult: Int8): Int8; register;

  TInterlockedOpArg16u = Function(A,B: UInt16; var InterlockedResult: UInt16): UInt16; register;
  TInterlockedOpArg16s = Function(A,B: Int16; var InterlockedResult: Int16): Int16; register;

  TInterlockedOpArg32u = Function(A,B: UInt32; var InterlockedResult: UInt32): UInt32; register;
  TInterlockedOpArg32s = Function(A,B: Int32; var InterlockedResult: Int32): Int32; register;

{$IFDEF IncludeVal64}
  TInterlockedOpArg64u = Function(A,B: UInt64; var InterlockedResult: UInt64): UInt64; register;
  TInterlockedOpArg64s = Function(A,B: Int64; var InterlockedResult: Int64): Int64; register;
{$ENDIF}

  TInterlockedOpArgPtr = Function(A,B: Pointer; var InterlockedResult: Pointer): Pointer; register;

  TInterlockedOpArgBool = Function(A,B: Boolean; var InterlockedResult: Boolean): Boolean; register;

//------------------------------------------------------------------------------

Function InterlockedOperation8(A: Pointer; B: UInt8; Op: TInterlockedOpArg8u): UInt8;{$IFDEF CanInline} inline;{$ENDIF} overload;
Function InterlockedOperation16(A: Pointer; B: UInt16; Op: TInterlockedOpArg16u): UInt16;{$IFDEF CanInline} inline;{$ENDIF} overload;
Function InterlockedOperation32(A: Pointer; B: UInt32; Op: TInterlockedOpArg32u): UInt32;{$IFDEF CanInline} inline;{$ENDIF} overload;
{$IFDEF IncludeVal64}
Function InterlockedOperation64(A: Pointer; B: UInt64; Op: TInterlockedOpArg64u): UInt64;{$IFDEF CanInline} inline;{$ENDIF} overload;
{$ENDIF}
Function InterlockedOperationPtr(A: Pointer; B: Pointer; Op: TInterlockedOpArgPtr): Pointer;{$IFDEF CanInline} inline;{$ENDIF} overload;
Function InterlockedOperationBool(A: Pointer; B: Boolean; Op: TInterlockedOpArgBool): Boolean;{$IFDEF CanInline} inline;{$ENDIF} overload;

//------------------------------------------------------------------------------

Function InterlockedOperation(var A: UInt8; B: UInt8; Op: TInterlockedOpArg8u): UInt8; overload;
Function InterlockedOperation(var A: Int8; B: Int8; Op: TInterlockedOpArg8s): Int8; overload;

Function InterlockedOperation(var A: UInt16; B: UInt16; Op: TInterlockedOpArg16u): UInt16; overload;
Function InterlockedOperation(var A: Int16; B: Int16; Op: TInterlockedOpArg16s): Int16; overload;

Function InterlockedOperation(var A: UInt32; B: UInt32; Op: TInterlockedOpArg32u): UInt32; overload;
Function InterlockedOperation(var A: Int32; B: Int32; Op: TInterlockedOpArg32s): Int32; overload;

{$IFDEF IncludeVal64}
Function InterlockedOperation(var A: UInt64; B: UInt64; Op: TInterlockedOpArg64u): UInt64; overload;
Function InterlockedOperation(var A: Int64; B: Int64; Op: TInterlockedOpArg64s): Int64; overload;
{$ENDIF}

Function InterlockedOperation(var A: Pointer; B: Pointer; Op: TInterlockedOpArgPtr): Pointer; overload;

Function InterlockedOperation(var A: Boolean; B: Boolean; Op: TInterlockedOpArgBool): Boolean; overload;

{===============================================================================
--------------------------------------------------------------------------------
                   Interlocked operation (array of arguments)                                                         
--------------------------------------------------------------------------------
===============================================================================}
{-------------------------------------------------------------------------------
  ...
  InterlockedOperation
    ...
    Works the same as overloads with one argument (see there for details, notes
    and warnings), except that the second argument is not a primitive type, but
    rather a constant variant open array - that is, you can pass any number
    (including zero) of arguments of almost any type.

    WARNING - be caureful what types you are passing to the interlocked
              functions and what are you doing with them in the operation
              routine.

-------------------------------------------------------------------------------}
type
  TInterlockedOpArr8u = Function(A: UInt8; const B: array of const; var InterlockedResult: UInt8): UInt8; register;
  TInterlockedOpArr8s = Function(A: Int8; const B: array of const; var InterlockedResult: Int8): Int8; register;

  TInterlockedOpArr16u = Function(A: UInt16; const B: array of const; var InterlockedResult: UInt16): UInt16; register;
  TInterlockedOpArr16s = Function(A: Int16; const B: array of const; var InterlockedResult: Int16): Int16; register;

  TInterlockedOpArr32u = Function(A: UInt32; const B: array of const; var InterlockedResult: UInt32): UInt32; register;
  TInterlockedOpArr32s = Function(A: Int32; const B: array of const; var InterlockedResult: Int32): Int32; register;

{$IFDEF IncludeVal64}
  TInterlockedOpArr64u = Function(A: UInt64; const B: array of const; var InterlockedResult: UInt64): UInt64; register;
  TInterlockedOpArr64s = Function(A: Int64; const B: array of const; var InterlockedResult: Int64): Int64; register;
{$ENDIF}

  TInterlockedOpArrPtr = Function(A: Pointer; const B: array of const; var InterlockedResult: Pointer): Pointer; register;

  TInterlockedOpArrBool = Function(A: Boolean; const B: array of const; var InterlockedResult: Boolean): Boolean; register;

//------------------------------------------------------------------------------

Function InterlockedOperation8(A: Pointer; const B: array of const; Op: TInterlockedOpArr8u): UInt8; overload;
Function InterlockedOperation16(A: Pointer; const B: array of const; Op: TInterlockedOpArr16u): UInt16; overload;
Function InterlockedOperation32(A: Pointer; const B: array of const; Op: TInterlockedOpArr32u): UInt32; overload;
{$IFDEF IncludeVal64}
Function InterlockedOperation64(A: Pointer; const B: array of const; Op: TInterlockedOpArr64u): UInt64; overload;
{$ENDIF}
Function InterlockedOperationPtr(A: Pointer; const B: array of const; Op: TInterlockedOpArrPtr): Pointer; overload;
Function InterlockedOperationBool(A: Pointer; const B: array of const; Op: TInterlockedOpArrBool): Boolean; overload;

//------------------------------------------------------------------------------

Function InterlockedOperation(var A: UInt8; const B: array of const; Op: TInterlockedOpArr8u): UInt8; overload;

Function InterlockedOperation(var A: Int8; const B: array of const; Op: TInterlockedOpArr8s): Int8; overload;

Function InterlockedOperation(var A: UInt16; const B: array of const; Op: TInterlockedOpArr16u): UInt16; overload;
Function InterlockedOperation(var A: Int16; const B: array of const; Op: TInterlockedOpArr16s): Int16; overload;

Function InterlockedOperation(var A: UInt32; const B: array of const; Op: TInterlockedOpArr32u): UInt32; overload;
Function InterlockedOperation(var A: Int32; const B: array of const; Op: TInterlockedOpArr32s): Int32; overload;

{$IFDEF IncludeVal64}
Function InterlockedOperation(var A: UInt64; const B: array of const; Op: TInterlockedOpArr64u): UInt64; overload;
Function InterlockedOperation(var A: Int64; const B: array of const; Op: TInterlockedOpArr64s): Int64; overload;
{$ENDIF}

Function InterlockedOperation(var A: Pointer; const B: array of const; Op: TInterlockedOpArrPtr): Pointer; overload;

Function InterlockedOperation(var A: Boolean; const B: array of const; Op: TInterlockedOpArrBool): Boolean; overload;
...
{-------------------------------------------------------------------------------
  ...
  InterlockedExchangeOp
    ...
    in parameter B, stores the result (that is, what the Op function returns)
    back in A and returns original value of A, everything in an atomic manner -
    ie. everything is completed thread-safe.

    See description of InterlockedOperation functions (above) for more details,
    warnings and notes.

-------------------------------------------------------------------------------}
type
  TInterlockedExOp8u = Function(A,B: UInt8): UInt8; register;
  TInterlockedExOp8s = Function(A,B: Int8): Int8; register;

  TInterlockedExOp16u = Function(A,B: UInt16): UInt16; register;
  TInterlockedExOp16s = Function(A,B: Int16): Int16; register;

  TInterlockedExOp32u = Function(A,B: UInt32): UInt32; register;
  TInterlockedExOp32s = Function(A,B: Int32): Int32; register;

{$IFDEF IncludeVal64}
  TInterlockedExOp64u = Function(A,B: UInt64): UInt64; register;
  TInterlockedExOp64s = Function(A,B: Int64): Int64; register;
{$ENDIF}

  TInterlockedExOpPtr = Function(A,B: Pointer): Pointer; register;

  TInterlockedExOpBool = Function(A,B: Boolean): Boolean; register;

//------------------------------------------------------------------------------

Function InterlockedExchangeOp8(A: Pointer; B: UInt8; Op: TInterlockedExOp8u): UInt8;{$IFDEF CanInline} inline;{$ENDIF}
Function InterlockedExchangeOp16(A: Pointer; B: UInt16; Op: TInterlockedExOp16u): UInt16;{$IFDEF CanInline} inline;{$ENDIF}
Function InterlockedExchangeOp32(A: Pointer; B: UInt32; Op: TInterlockedExOp32u): UInt32;{$IFDEF CanInline} inline;{$ENDIF}
{$IFDEF IncludeVal64}
Function InterlockedExchangeOp64(A: Pointer; B: UInt64; Op: TInterlockedExOp64u): UInt64;{$IFDEF CanInline} inline;{$ENDIF}
{$ENDIF}
Function InterlockedExchangeOpPtr(A: Pointer; B: Pointer; Op: TInterlockedExOpPtr): Pointer;{$IFDEF CanInline} inline;{$ENDIF}
Function InterlockedExchangeOpBool(A: Pointer; B: Boolean; Op: TInterlockedExOpBool): Boolean;{$IFDEF CanInline} inline;{$ENDIF}

//------------------------------------------------------------------------------

Function InterlockedExchangeOp(var A: UInt8; B: UInt8; Op: TInterlockedExOp8u): UInt8; overload;
Function InterlockedExchangeOp(var A: Int8; B: Int8; Op: TInterlockedExOp8s): Int8; overload;

Function InterlockedExchangeOp(var A: UInt16; B: UInt16; Op: TInterlockedExOp16u): UInt16; overload;
Function InterlockedExchangeOp(var A: Int16; B: Int16; Op: TInterlockedExOp16s): Int16; overload;

Function InterlockedExchangeOp(var A: UInt32; B: UInt32; Op: TInterlockedExOp32u): UInt32; overload;
Function InterlockedExchangeOp(var A: Int32; B: Int32; Op: TInterlockedExOp32s): Int32; overload;

{$IFDEF IncludeVal64}
Function InterlockedExchangeOp(var A: UInt64; B: UInt64; Op: TInterlockedExOp64u): UInt64; overload;
Function InterlockedExchangeOp(var A: Int64; B: Int64; Op: TInterlockedExOp64s): Int64; overload;
{$ENDIF}

Function InterlockedExchangeOp(var A: Pointer; B: Pointer; Op: TInterlockedExOpPtr): Pointer; overload;

Function InterlockedExchangeOp(var A: Boolean; B: Boolean; Op: TInterlockedExOpBool): Boolean; overload;
...
Function InterlockedOperation8(A: Pointer; Op: TInterlockedOp8u): UInt8;
begin
Result := InterlockedOperation(UInt8(A^),Op);
end;

//------------------------------------------------------------------------------

Function InterlockedOperation16(A: Pointer; Op: TInterlockedOp16u): UInt16;
begin
Result := InterlockedOperation(UInt16(A^),Op);
end;

//------------------------------------------------------------------------------

Function InterlockedOperation32(A: Pointer; Op: TInterlockedOp32u): UInt32;
begin
Result := InterlockedOperation(UInt32(A^),Op);
end;
...
Function InterlockedOperation64(A: Pointer; Op: TInterlockedOp64u): UInt64;
begin
Result := InterlockedOperation(UInt64(A^),Op);
end;
...
Function InterlockedOperationPtr(A: Pointer; Op: TInterlockedOpPtr): Pointer;
begin
Result := InterlockedOperation(Pointer(A^),Op);
end;

//------------------------------------------------------------------------------

Function InterlockedOperationBool(A: Pointer; Op: TInterlockedOpBool): Boolean;
begin
Result := InterlockedOperation(Boolean(A^),Op);
end;

//==============================================================================

Function InterlockedOperation(var A: UInt8; Op: TInterlockedOp8u): UInt8;
var
  OldValue: UInt8;
  NewValue: UInt8;
begin
repeat
  OldValue := A;
  Result := OldValue;
  NewValue := Op(OldValue,Result);
until InterlockedCompareExchange8(@A,NewValue,OldValue) = OldValue;
end;

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

Function InterlockedOperation(var A: Int8; Op: TInterlockedOp8s): Int8;
var
  OldValue: Int8;
  NewValue: Int8;
begin
repeat
  ...
  Result := OldValue;
  NewValue := Op(OldValue,Result);
until InterlockedCompareExchange8(@A,UInt8(NewValue),UInt8(OldValue)) = UInt8(OldValue);
end;

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

Function InterlockedOperation(var A: UInt16; Op: TInterlockedOp16u): UInt16;
var
  OldValue: UInt16;
  NewValue: UInt16;
begin
repeat
  ...
  Result := OldValue;
  NewValue := Op(OldValue,Result);
until InterlockedCompareExchange16(@A,NewValue,OldValue) = OldValue;
end;

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

Function InterlockedOperation(var A: Int16; Op: TInterlockedOp16s): Int16;
var
  OldValue: Int16;
  NewValue: Int16;
begin
repeat
  ...
  Result := OldValue;
  NewValue := Op(OldValue,Result);
until InterlockedCompareExchange16(@A,UInt16(NewValue),UInt16(OldValue)) = UInt16(OldValue);
end;

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

Function InterlockedOperation(var A: UInt32; Op: TInterlockedOp32u): UInt32;
var
  OldValue: UInt32;
  NewValue: UInt32;
begin
repeat
  ...
  Result := OldValue;
  NewValue := Op(OldValue,Result);
until InterlockedCompareExchange32(@A,NewValue,OldValue) = OldValue;
end;

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

Function InterlockedOperation(var A: Int32; Op: TInterlockedOp32s): Int32;
var
  OldValue: Int32;
  NewValue: Int32;
begin
repeat
  ...
  Result := OldValue;
  NewValue := Op(OldValue,Result);
until InterlockedCompareExchange32(@A,UInt32(NewValue),UInt32(OldValue)) = UInt32(OldValue);
end;
...
Function InterlockedOperation(var A: UInt64; Op: TInterlockedOp64u): UInt64;
var
  OldValue: UInt64;
  NewValue: UInt64;
begin
repeat
  ...
  Result := OldValue;
  NewValue := Op(OldValue,Result);
until InterlockedCompareExchange64(@A,NewValue,OldValue) = OldValue;
end;

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

Function InterlockedOperation(var A: Int64; Op: TInterlockedOp64s): Int64;
var
  OldValue: Int64;
  NewValue: Int64;
begin
repeat
  ...
  Result := OldValue;
  NewValue := Op(OldValue,Result);
until InterlockedCompareExchange64(@A,UInt64(NewValue),UInt64(OldValue)) = UInt64(OldValue);
end;
...
Function InterlockedOperation(var A: Pointer; Op: TInterlockedOpPtr): Pointer;
var
  OldValue: Pointer;
  NewValue: Pointer;
begin
...
{$IFDEF FPCDWM}{$PUSH}W4055{$ENDIF}
{$IFDEF Ptr64}
until Pointer(InterlockedCompareExchange64(@A,UInt64(NewValue),UInt64(OldValue))) = OldValue;
{$ELSE}
until Pointer(InterlockedCompareExchange32(@A,UInt32(NewValue),UInt32(OldValue))) = OldValue;
{$ENDIF}
{$IFDEF FPCDWM}{$POP}{$ENDIF}
end;
...
Function InterlockedOperation(var A: Boolean; Op: TInterlockedOpBool): Boolean;
var
  OldValue: Boolean;
  NewValue: Boolean;
begin
...
Function InterlockedOperation8(A: Pointer; B: UInt8; Op: TInterlockedOpArg8u): UInt8;
begin
Result := InterlockedOperation(UInt8(A^),B,Op);
end;

//------------------------------------------------------------------------------

Function InterlockedOperation16(A: Pointer; B: UInt16; Op: TInterlockedOpArg16u): UInt16;
begin
Result := InterlockedOperation(UInt16(A^),B,Op);
end;

//------------------------------------------------------------------------------

Function InterlockedOperation32(A: Pointer; B: UInt32; Op: TInterlockedOpArg32u): UInt32;
begin
Result := InterlockedOperation(UInt32(A^),B,Op);
end;
...
Function InterlockedOperation64(A: Pointer; B: UInt64; Op: TInterlockedOpArg64u): UInt64;
begin
Result := InterlockedOperation(UInt64(A^),B,Op);
end;
...
Function InterlockedOperationPtr(A: Pointer; B: Pointer; Op: TInterlockedOpArgPtr): Pointer;
begin
Result := InterlockedOperation(Pointer(A^),B,Op);
end;

//------------------------------------------------------------------------------

Function InterlockedOperationBool(A: Pointer; B: Boolean; Op: TInterlockedOpArgBool): Boolean;
begin
Result := InterlockedOperation(Boolean(A^),B,Op);
end;

//==============================================================================

Function InterlockedOperation(var A: UInt8; B: UInt8; Op: TInterlockedOpArg8u): UInt8;
var
  OldValue: UInt8;
  NewValue: UInt8;
begin
repeat
  OldValue := A;
  Result := OldValue;
  NewValue := Op(OldValue,B,Result);
until InterlockedCompareExchange8(@A,NewValue,OldValue) = OldValue;
end;

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

Function InterlockedOperation(var A: Int8; B: Int8; Op: TInterlockedOpArg8s): Int8;
var
  OldValue: Int8;
  NewValue: Int8;
begin
...
Function InterlockedOperation(var A: UInt16; B: UInt16; Op: TInterlockedOpArg16u): UInt16;
var
  OldValue: UInt16;
  NewValue: UInt16;
begin
...
Function InterlockedOperation(var A: Int16; B: Int16; Op: TInterlockedOpArg16s): Int16;
var
  OldValue: Int16;
  NewValue: Int16;
begin
...
Function InterlockedOperation(var A: UInt32; B: UInt32; Op: TInterlockedOpArg32u): UInt32;
var
  OldValue: UInt32;
  NewValue: UInt32;
begin
...
Function InterlockedOperation(var A: Int32; B: Int32; Op: TInterlockedOpArg32s): Int32;
var
  OldValue: Int32;
  NewValue: Int32;
begin
...
Function InterlockedOperation(var A: UInt64; B: UInt64; Op: TInterlockedOpArg64u): UInt64;
var
  OldValue: UInt64;
  NewValue: UInt64;
begin
...
Function InterlockedOperation(var A: Int64; B: Int64; Op: TInterlockedOpArg64s): Int64;
var
  OldValue: Int64;
  NewValue: Int64;
begin
...
Function InterlockedOperation(var A: Pointer; B: Pointer; Op: TInterlockedOpArgPtr): Pointer;
var
  OldValue: Pointer;
  NewValue: Pointer;
begin
...
Function InterlockedOperation(var A: Boolean; B: Boolean; Op: TInterlockedOpArgBool): Boolean;
var
  OldValue: Boolean;
  NewValue: Boolean;
begin
...
Function InterlockedOperation8(A: Pointer; const B: array of const; Op: TInterlockedOpArr8u): UInt8;
begin
Result := InterlockedOperation(UInt8(A^),B,Op);
end;
...
Function InterlockedOperation16(A: Pointer; const B: array of const; Op: TInterlockedOpArr16u): UInt16;
begin
Result := InterlockedOperation(UInt16(A^),B,Op);
end;
...
Function InterlockedOperation32(A: Pointer; const B: array of const; Op: TInterlockedOpArr32u): UInt32;
begin
Result := InterlockedOperation(UInt32(A^),B,Op);
end;
...
Function InterlockedOperation64(A: Pointer; const B: array of const; Op: TInterlockedOpArr64u): UInt64;
begin
Result := InterlockedOperation(UInt64(A^),B,Op);
end;
...
Function InterlockedOperationPtr(A: Pointer; const B: array of const; Op: TInterlockedOpArrPtr): Pointer;
begin
Result := InterlockedOperation(Pointer(A^),B,Op);
end;
...
Function InterlockedOperationBool(A: Pointer; const B: array of const; Op: TInterlockedOpArrBool): Boolean;
begin
Result := InterlockedOperation(Boolean(A^),B,Op);
end;
...
Function InterlockedOperation(var A: UInt8; const B: array of const; Op: TInterlockedOpArr8u): UInt8;
var
  OldValue: UInt8;
  NewValue: UInt8;
begin
...
Function InterlockedOperation(var A: Int8; const B: array of const; Op: TInterlockedOpArr8s): Int8;
var
  OldValue: Int8;
  NewValue: Int8;
begin
...
Function InterlockedOperation(var A: UInt16; const B: array of const; Op: TInterlockedOpArr16u): UInt16;
var
  OldValue: UInt16;
  NewValue: UInt16;
begin
...
Function InterlockedOperation(var A: Int16; const B: array of const; Op: TInterlockedOpArr16s): Int16;
var
  OldValue: Int16;
  NewValue: Int16;
begin
...
Function InterlockedOperation(var A: UInt32; const B: array of const; Op: TInterlockedOpArr32u): UInt32;
var
  OldValue: UInt32;
  NewValue: UInt32;
begin
...
Function InterlockedOperation(var A: Int32; const B: array of const; Op: TInterlockedOpArr32s): Int32;
var
  OldValue: Int32;
  NewValue: Int32;
begin
...
Function InterlockedOperation(var A: UInt64; const B: array of const; Op: TInterlockedOpArr64u): UInt64;
var
  OldValue: UInt64;
  NewValue: UInt64;
begin
...
Function InterlockedOperation(var A: Int64; const B: array of const; Op: TInterlockedOpArr64s): Int64;
var
  OldValue: Int64;
  NewValue: Int64;
begin
...
Function InterlockedOperation(var A: Pointer; const B: array of const; Op: TInterlockedOpArrPtr): Pointer;
var
  OldValue: Pointer;
  NewValue: Pointer;
begin
...
Function InterlockedOperation(var A: Boolean; const B: array of const; Op: TInterlockedOpArrBool): Boolean;
var
  OldValue: Boolean;
  NewValue: Boolean;
begin
...
Function InterlockedExchangeOp8(A: Pointer; B: UInt8; Op: TInterlockedExOp8u): UInt8;
begin
...
Function InterlockedExchangeOp16(A: Pointer; B: UInt16; Op: TInterlockedExOp16u): UInt16;
begin
...
Function InterlockedExchangeOp32(A: Pointer; B: UInt32; Op: TInterlockedExOp32u): UInt32;
begin
...
Function InterlockedExchangeOp64(A: Pointer; B: UInt64; Op: TInterlockedExOp64u): UInt64;
begin
...
Function InterlockedExchangeOpPtr(A: Pointer; B: Pointer; Op: TInterlockedExOpPtr): Pointer;
begin
...
Function InterlockedExchangeOpBool(A: Pointer; B: Boolean; Op: TInterlockedExOpBool): Boolean;
begin
...
Function InterlockedExchangeOp(var A: UInt8; B: UInt8; Op: TInterlockedExOp8u): UInt8;
var
  NewValue: UInt8;
begin
repeat
...
Function InterlockedExchangeOp(var A: Int8; B: Int8; Op: TInterlockedExOp8s): Int8;
var
  NewValue: Int8;
begin
repeat
...
Function InterlockedExchangeOp(var A: UInt16; B: UInt16; Op: TInterlockedExOp16u): UInt16;
var
  NewValue: UInt16;
begin
repeat
...
Function InterlockedExchangeOp(var A: Int16; B: Int16; Op: TInterlockedExOp16s): Int16;
var
  NewValue: Int16;
begin
repeat
...
Function InterlockedExchangeOp(var A: UInt32; B: UInt32; Op: TInterlockedExOp32u): UInt32;
var
  NewValue: UInt32;
begin
repeat
...
Function InterlockedExchangeOp(var A: Int32; B: Int32; Op: TInterlockedExOp32s): Int32;
var
  NewValue: Int32;
begin
repeat
...
Function InterlockedExchangeOp(var A: UInt64; B: UInt64; Op: TInterlockedExOp64u): UInt64;
var
  NewValue: UInt64;
begin
repeat
...
Function InterlockedExchangeOp(var A: Int64; B: Int64; Op: TInterlockedExOp64s): Int64;
var
  NewValue: Int64;
begin
repeat
...
Function InterlockedExchangeOp(var A: Pointer; B: Pointer; Op: TInterlockedExOpPtr): Pointer;
var
  NewValue: Pointer;
begin
repeat
...
Function InterlockedExchangeOp(var A: Boolean; B: Boolean; Op: TInterlockedExOpBool): Boolean;
var
  NewValue: Boolean;
begin
repeat
