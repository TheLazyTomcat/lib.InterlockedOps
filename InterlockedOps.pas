...
{-------------------------------------------------------------------------------
  ...
  InterlockedOperation
    ...
    this function) on variable (pointed to by) A and returns result of this
    operation (what the Op function returns), everything in an atomic manner -
    that is, everything is completed thread-safe.
    ...
    WARNING - The Op function must be maximally simple, short, fast, thread
              ...
              generated by the compiler, no use of global variables, do not
              raise any exceptions, ...)

    WARNING - Value of A upon entry to Op function might not necessarily
              reflect what the original variable A stores. Be prepared and
              do not panic (eg. by raising an exception) if it receives
              unexpected, bizzare or erroneous value - the operation will
              certainly be called again with a correct value.
...
-------------------------------------------------------------------------------}
type
  TInterlockedOp8u = Function(var A: UInt8): UInt8; register;
  TInterlockedOp8s = Function(var A: Int8): Int8; register;

  TInterlockedOp16u = Function(var A: UInt16): UInt16; register;
  TInterlockedOp16s = Function(var A: Int16): Int16; register;

  TInterlockedOp32u = Function(var A: UInt32): UInt32; register;
  TInterlockedOp32s = Function(var A: Int32): Int32; register;

{$IFDEF IncludeVal64}
  TInterlockedOp64u = Function(var A: UInt64): UInt64; register;
  TInterlockedOp64s = Function(var A: Int64): Int64; register;
{$ENDIF}

  TInterlockedOpPtr = Function(var A: Pointer): Pointer; register;

  TInterlockedOpBool = Function(var A: Boolean): Boolean; register;
...
-------------------------------------------------------------------------------}
type
  TInterlockedOpArg8u = Function(var A: UInt8; B: UInt8): UInt8; register;
  TInterlockedOpArg8s = Function(var A: Int8; B: Int8): Int8; register;

  TInterlockedOpArg16u = Function(var A: UInt16; B: UInt16): UInt16; register;
  TInterlockedOpArg16s = Function(var A: Int16; B: Int16): Int16; register;

  TInterlockedOpArg32u = Function(var A: UInt32; B: UInt32): UInt32; register;
  TInterlockedOpArg32s = Function(var A: Int32; B: Int32): Int32; register;

{$IFDEF IncludeVal64}
  TInterlockedOpArg64u = Function(var A: UInt64; B: UInt64): UInt64; register;
  TInterlockedOpArg64s = Function(var A: Int64; B: Int64): Int64; register;
{$ENDIF}

  TInterlockedOpArgPtr = Function(var A: Pointer; B: Pointer): Pointer; register;

  TInterlockedOpArgBool = Function(var A: Boolean; B: Boolean): Boolean; register;
...
-------------------------------------------------------------------------------}
type
  TInterlockedOpArr8u = Function(var A: UInt8; const B: array of const): UInt8; register;
  TInterlockedOpArr8s = Function(var A: Int8; const B: array of const): Int8; register;

  TInterlockedOpArr16u = Function(var A: UInt16; const B: array of const): UInt16; register;
  TInterlockedOpArr16s = Function(var A: Int16; const B: array of const): Int16; register;

  TInterlockedOpArr32u = Function(var A: UInt32; const B: array of const): UInt32; register;
  TInterlockedOpArr32s = Function(var A: Int32; const B: array of const): Int32; register;

{$IFDEF IncludeVal64}
  TInterlockedOpArr64u = Function(var A: UInt64; const B: array of const): UInt64; register;
  TInterlockedOpArr64s = Function(var A: Int64; const B: array of const): Int64; register;
{$ENDIF}

  TInterlockedOpArrPtr = Function(var A: Pointer; const B: array of const): Pointer; register;

  TInterlockedOpArrBool = Function(var A: Boolean; const B: array of const): Boolean; register;
...
{-------------------------------------------------------------------------------
  ...
  InterlockedExchangeOp
    ...
    Performs operation implemented in function passed as Op parameter (calls
    this function) on variable (pointed to by) A with value given in parameter
    B, and returns original value of A, everything in an atomic manner - ie.
...
-------------------------------------------------------------------------------}
type
  TInterlockedExOp8u = procedure(var A: UInt8; B: UInt8); register;
  TInterlockedExOp8s = procedure(var A: Int8; B: Int8); register;

  TInterlockedExOp16u = procedure(var A: UInt16; B: UInt16); register;
  TInterlockedExOp16s = procedure(var A: Int16; B: Int16); register;

  TInterlockedExOp32u = procedure(var A: UInt32; B: UInt32); register;
  TInterlockedExOp32s = procedure(var A: Int32; B: Int32); register;

{$IFDEF IncludeVal64}
  TInterlockedExOp64u = procedure(var A: UInt64; B: UInt64); register;
  TInterlockedExOp64s = procedure(var A: Int64; B: Int64); register;
{$ENDIF}

  TInterlockedExOpPtr = procedure(var A: Pointer; B: Pointer); register;

  TInterlockedExOpBool = procedure(var A: Boolean; B: Boolean); register;
